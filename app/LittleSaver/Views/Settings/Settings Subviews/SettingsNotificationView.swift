...
struct SettingsNotificationsView: View {
  ...
  @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: AppIdentifiers.appGroup))
  ...
  var body: some View {
    VStack {
      ...
      if showNotifications {
        ...
        .onAppear {
          if UserDefaults(suiteName: AppIdentifiers.appGroup)!.object(
            forKey: "notificationOption") != nil {
            option = UserDefaults(suiteName: AppIdentifiers.appGroup)!.integer(
              forKey: "notificationOption")
          }

          if UserDefaults(suiteName: AppIdentifiers.appGroup)!.object(forKey: "customHour")
            != nil
            && UserDefaults(suiteName: AppIdentifiers.appGroup)!.object(forKey: "customMinute")
              != nil {
            var components = DateComponents()
            components.hour = UserDefaults(suiteName: AppIdentifiers.appGroup)!.integer(
              forKey: "customHour")
            components.minute = UserDefaults(suiteName: AppIdentifiers.appGroup)!.integer(
              forKey: "customMinute")
...
func newNotification() {
  ...
  if UserDefaults(suiteName: AppIdentifiers.appGroup)!.object(forKey: "notificationOption")
    != nil {
    option = UserDefaults(suiteName: AppIdentifiers.appGroup)!.integer(
      forKey: "notificationOption")
  }
  ...
  if option == 1 {
    ...
    if UserDefaults(suiteName: AppIdentifiers.appGroup)!.object(forKey: "customHour") != nil,
      UserDefaults(suiteName: AppIdentifiers.appGroup)!.object(forKey: "customMinute") != nil {
      components.hour = UserDefaults(suiteName: AppIdentifiers.appGroup)!.integer(
        forKey: "customHour")
      components.minute = UserDefaults(suiteName: AppIdentifiers.appGroup)!.integer(
        forKey: "customMinute")
