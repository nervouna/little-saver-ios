...
struct SettingsGoofyView: View {
  ...
  @AppStorage("budgetViewStyle", store: UserDefaults(suiteName: AppIdentifiers.appGroup))
  var budgetRows: Bool = false

  @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: AppIdentifiers.appGroup))
